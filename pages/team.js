    ...
    <>
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <h1 className="section-heading">The people behind Helio.</h1>
      ...
      <section className="pb-20 md:pb-28 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-2xl font-semibold text-slate-850 mb-8">Founders</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {founders.map(({ name, role, bio }) => (
              <div key={name} className="card">
                <h3 className="text-xl font-semibold text-slate-850">{name}</h3>
      ...
      <section className="pb-20 md:pb-28 bg-stone-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-2xl font-semibold text-slate-850 mb-8">Advisors</h2>
          <div className="grid sm:grid-cols-2 gap-6">
            {advisors.map(({ name, affiliation }) => (
              <div key={name} className="card">
                <h3 className="text-lg font-semibold text-slate-850">{name}</h3>
      ...
      <section className="pb-20 md:pb-28 bg-stone-50">
        <div className="max-w-6xl mx-auto px-6">
          <figure className="card p-0 overflow-hidden max-w-2xl">
            ...
            <figcaption className="px-6 py-4 text-sm text-slate-500 border-t border-stone-100">
      ...
      <section className="py-16 bg-helio-700">
